    ...
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          errors.website && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mt-1", children: errors.website.message })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "label",
          ...
          errors.username && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mt-1", children: errors.username.message })
        ] }),
...
function FaRegCopy(props) {
  return GenIcon({ "tag": "svg", "attr": { "viewBox": "0 0 448 512" }, "child": [{ "tag": "path", "attr": { "d": "M384 336l-192 0c-8.8 0-16-7.2-16-16l0-256c0-8.8 7.2-16 16-16l140.1 0L400 115.9 400 320c0 8.8-7.2 16-16 16zM192 384l192 0c35.3 0 64-28.7 64-64l0-204.1c0-12.7-5.1-24.9-14.1-33.9L366.1 14.1c-9-9-21.2-14.1-33.9-14.1L192 0c-35.3 0-64 28.7-64 64l0 256c0 35.3 28.7 64 64 64zM64 128c-35.3 0-64 28.7-64 64L0 448c0 35.3 28.7 64 64 64l192 0c35.3 0 64-28.7 64-64l0-32-48 0 0 32c0 8.8-7.2 16-16 16L64 464c-8.8 0-16-7.2-16-16l0-256c0-8.8 7.2-16 16-16l32 0 0-48-32 0z" }, "child": [] }] })(props);
}
...
function PasswordItem({ password, setPasswords, passwords, index: index2 }) {
  ...
  const handleDelete = () => {
    ...
    if (confirmed) {
      setPasswords(
        (prevPasswords) => prevPasswords.filter((_, i) => i !== index2)
      );
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-4 border rounded", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center  space-x-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Username:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => handleCopy(password.username, "Username"),
              className: `btn btn-sm ${copiedField === "Username" ? "text-green-500" : ""}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaRegCopy, {})
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Password:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleDelete, className: "btn btn-sm text-red-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaTrash, {}) })
      ] })
    ] }),
    showDialog && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 flex items-center justify-center bg-black bg-opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded shadow-lg w-96", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Total Passwords Saved:" }),
        " ",
        passwords.length
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function PasswordList({ passwords, setPasswords }) {
  ...
  const filteredPasswords = passwords.filter(
    (password) => password.website.toLowerCase().includes(search.toLowerCase())
  );
  const showPasswordsInJson = () => {
    navigate("/json", { state: { passwords } });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4 space-x-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          maxHeight: "500px"
          // 3 items * estimated height of 84px per item
        },
        children: [
          filteredPasswords.map((password, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            PasswordItem,
            {
              password,
              setPasswords,
          ...
          filteredPasswords.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-center mt-4", children: "No matching passwords found." })
        ]
      }
    )
  ] });
...
function JsonPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4", children: "Passwords JSON" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "pre",
      {
        style: {
        ...
        children: JSON.stringify(passwords, null, 2)
      }
    )
  ] });
}
function NewPass({ setPasswords }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: "bg-red-400 p-4 rounded-full w-full",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        path: "/",
        element: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-4 max-w-[600px] bg-purple-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PasswordList, { passwords, setPasswords }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(NewPass, { setPasswords })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/json", element: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonPage, {}) })
  ] }) });
}
const index = "";
